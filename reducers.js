...
Above creates new object with state and other object

Is equivalent to: (This will be a new feature soon, for now you must use babel polyfill)
...
export default function ducks (state = initialState, action) {
  switch (action.type) {
    case FETCHING_DUCK :
      ...
      // Adding both casses on top like below
      // means do the same thing for both cases
    case ADD_DUCK :
